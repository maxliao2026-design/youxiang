...
/* ========== 1. 資料設定 ========== */
const MENU_IMAGES = [
  "/images/menu/coquitlam/page1.jpg",
  "/images/menu/coquitlam/page2.jpg",
  "/images/menu/coquitlam/page3-beer.jpg",
];
...
const TRANSLATIONS = {
  "zh-TW": {
    meta: {
      title: "有香(Coquitlam)菜單 | Memory Corner",
      description:
        "有香 Memory Corner (Coquitlam) 完整菜單。提供經典台灣小吃、羊肉爐、各式鍋物與台灣精釀啤酒。",
    },
    breadcrumb: {
      home: "首頁",
      brand_menu: "品牌菜單",
      current: "有香(Coquitlam)菜單",
    },
    heading: "有香(Coquitlam) ｜ 『經典台灣料理』｜ 菜 單",
    imageAlt: "有香(Coquitlam)菜單頁面",
  },
  en: {
    meta: {
      title: "Memory Corner (Coquitlam) Menu | Memory Corner",
      description:
        "Full menu of Memory Corner (Coquitlam). Serving authentic Taiwanese snacks, Lamb Hot Pot, hot pots, and Taiwanese craft beer.",
    },
    breadcrumb: {
      home: "Home",
      brand_menu: "Brand Menu",
      current: "Memory Corner (Coquitlam) Menu",
    },
    heading: "Memory Corner (Coquitlam) | Classic Taiwanese Cuisine | Menu",
    imageAlt: "Memory Corner (Coquitlam) Menu Page",
  },
};
